Shader "Custom/Voxel Standard Array"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        void vert(inout appdata_full v, out Input o)
        {
            ...
            o.arrayIndex = v.texcoord2.x; //the arrayIndex, or index of the texture in the array to sample, comes from the thrid uv coord x value.
            o.color = v.color;
        }
